...
public class LinkRelicItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        if (!getPlayerName(stack).isBlank())
            tooltip.add(coloredTextComponent(getPlayerName(stack) + " " + new TranslatableComponent("randomisfits.link_relic.linked").getString(), ChatFormatting.GRAY));
    }
    ...
    private void setPlayerName(ItemStack stack, String name, Player player) {
        ...
        player.displayClientMessage(coloredTextComponent(name + " " + new TranslatableComponent("randomisfits.link_relic.linked").getString(), ChatFormatting.GOLD), true);
    }
