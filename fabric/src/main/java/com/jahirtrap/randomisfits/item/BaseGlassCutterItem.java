...
public class BaseGlassCutterItem extends DiggerItem {
    private static final TagKey<Block> MINEABLE_WITH_GLASS_CUTTER = TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(MODID, "mineable/glass_cutter"));
