...
public class BaseGlassCutterItem extends DiggerItem {
    private static final TagKey<Block> MINEABLE_WITH_GLASS_CUTTER = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(MODID, "mineable/glass_cutter"));

    public BaseGlassCutterItem(Tier tier, Properties properties) {
        super(-1, -2f, tier, MINEABLE_WITH_GLASS_CUTTER, properties.tab(TAB_RANDOMISFITS));
    }
